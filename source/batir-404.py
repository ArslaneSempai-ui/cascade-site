...
CSS = '''
  ...
  *{box-sizing:border-box;margin:0}
  ...
  /* la scène : le robot DEVANT la case blanche, son bas s'arrête où le blanc finit */
  .scene{position:relative;width:min(430px,72vw);padding-top:154px;margin:0 0 6px}
  .case{position:relative;z-index:1;width:100%;height:190px;background:#e9e4d3;border-radius:16px;
    box-shadow:0 34px 90px rgba(0,0,0,.55),inset 0 0 0 1px rgba(27,29,24,.08)}
  .scene img{position:absolute;left:50%;transform:translateX(-50%);bottom:0;width:82%;z-index:2;
