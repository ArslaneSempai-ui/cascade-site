...
<section class="jours" aria-label="The days"><div class="colonne">
  ...
  <p class="jours-l">Thirty days to decide, on your own records. Then a signature, sixty days to the balance, the year.</p>
    ...
    <div class="axe" id="axe">
      <div class="voies">
        ...
        <div class="voie" style="--t:2" data-l="lic"><span class="v-nom">The licence</span>
          ...
          <span class="pap" style="--d:150;--tx:-100%"><span>month 12</span><b>renewal capped, CPI-U or 5%</b></span>
        </div>
      </div>
