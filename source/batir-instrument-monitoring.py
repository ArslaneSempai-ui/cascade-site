...
De instrument-monitoring-donnees.json, emis par extraire-instrument-monitoring.mjs :
le releve public scelle de cascade-monitoring, verifie puis recompose cellule par
...
D = json.loads((BASE / "instrument-monitoring-donnees.json").read_text())
...
CSS = '''
  :root{--nuit-a:#16213a;--nuit-b:#101a30;--nuit-c:#0a111f;
    --sur:#e6ecf7;--sur-pale:#a8b7d4;
    --papier:#dbd7c5;--papier-haut:#e2ddcb;--encre:#1b1d18;--demi:#4a4739;--pale:#55523f;
    --filet-clair:#bab7a0;
    --accent-titre:#1f3f7a;--accent-vif:#4f8ae0;--accent-clair:#c3d8ff;
  ...
  *{box-sizing:border-box;margin:0}
  ...
  .tete{padding:192px 0 30px;
    background:radial-gradient(120% 100% at 50% -20%,#14213f,var(--nuit-b) 70%)}
  ...
  .terminal::after{content:"";position:absolute;inset:0;pointer-events:none;border-radius:14px;
    background:repeating-linear-gradient(to bottom,rgba(195,216,255,.016) 0 1px,transparent 1px 3px)}
...
JS = '''
  ...
  function lire(c) {
    ...
    $("#g-lecture").innerHTML = "<b>" + c.dataset.p + "</b> at threshold <b>" + c.dataset.s + "</b>: "
      + "recall on confirmed suspicious cases <b>" + pc1(cel.rappel.taux) + "</b> " + iv(cel.rappel) + ", n=" + cel.rappel.n
...
PHRASE_ABSENTS = (
    ...
    if ABSENTS else
    "every scenario of the registry is present tonight; an absent one would be a named row, "
...
<meta property="og:description" content="Every scenario at every threshold on the sealed public record: recall against false alerts, intervals everywhere, the tool's own selection rule under your recall floor.">
<meta property="og:url" content="https://cascade-routing.com/monitoring/instrument.html">
<meta name="twitter:card" content="summary_large_image">
<meta name="description" content="Every scenario at every threshold on the sealed public record: recall against false alerts, intervals everywhere, the tool's own selection rule under your recall floor.">
...
<header class="barre">
  ...
  <nav aria-label="Site">
    <a href="INSTRUMENT-MONITORING.html" aria-current="page">Instrument</a>
    <a href="../ENGAGEMENT.html">Pricing</a>
    <a href="ANNEXE-MONITORING-METHODE.html">Method</a>
    <a href="ANNEXE-MONITORING-SECURITE.html">Security</a>
...
<section class="tete">
  <div class="colonne">
    <h1 class="h1">Every scenario at every threshold, live.</h1>
...
<section class="poste">
  <div class="colonne">
    <div class="dessus">
      ...
      <div class="pan-col">
      <img class="rb" src="../rendus/robot-lapis-regarde.webp" alt="">
      {PANNEAU_HTML}
      </div>
      </div>
    </div>
...
(BASE / "INSTRUMENT-MONITORING.html").write_text(PAGE, encoding="utf-8")
print(f"INSTRUMENT-MONITORING.html {len(PAGE) / 1e3:.0f} ko")
