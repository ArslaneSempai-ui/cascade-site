...
{barre_site(courant=OUTILS["screening"]["page_hero"], sceau=D["provenance"]["empreinte"], racine="../")}
...
{pied_html(outil=OUTILS["screening"], sceau=D["provenance"]["empreinte"], tests=n_tests(OUTILS["screening"]))}
